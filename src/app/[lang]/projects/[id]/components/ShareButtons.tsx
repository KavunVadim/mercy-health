...
export default function ShareButtons({ title, projectUrl, shareLabel, dictionary }: ShareButtonsProps) {
    ...
    return [
      {
        ...
        url: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(currentUrl)}&quote=${encodeURIComponent(title)}`,
        color: "#1877F2",
        icon: (
        ...
        <div className={styles.topRow}>
          <div className={styles.socialGrid}>
              ...
              <a
                ...
                className={`${styles.socialBtn} ${!link.url ? styles.disabled : ''}`}
