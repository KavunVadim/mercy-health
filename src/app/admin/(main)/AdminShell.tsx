...
import { Menu, X, LayoutDashboard, Newspaper, FolderOpen, Image, LogOut, Users, FileText, Settings, SlidersHorizontal, FileEdit } from 'lucide-react';
...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      ...
      <aside className={`${styles.adminSidebar} ${sidebarOpen ? styles.sidebarOpen : styles.sidebarClosed}`}>
