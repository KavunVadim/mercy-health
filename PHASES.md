...
- Two-section nav: **Благодійний фонд** | **Центр реабілітації** (tabs or split)
- Mega-dropdown menus on hover
- Phone numbers (fund + center)
...
## Phase 6 — Rehabilitation Center Section
**Goal**: Separate visual section for the Center (second part of site).

### Features
- Divider / section break with distinct visual treatment
- About the center (mission, vision)
- Services grid:
  - Психологічна допомога
  - Фізична реабілітація
  - Підтримка родин
  - Підтримка дітей
- Team cards (photo + name + role)
- Mobile groups map (regions)
- Branches list

### Components
```
src/components/sections/RehabCenter.tsx
